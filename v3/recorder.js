/**
 * WillingTree Demo Flow Recorder V3
 *
 * Updated with new sketched SVG icons and step/substep naming
 *
 * Usage:
...
async function recordDemoFlow() {
    console.log('🎬 Starting WillingTree V3 demo recording (with SVG icons)...\\n');
    ...
    // Load the demo
    const demoPath = 'file://' + path.join(__dirname, 'index.html');
    ...
    console.log('📝 This V3 demo showcases the new sketched SVG icons!');
}
